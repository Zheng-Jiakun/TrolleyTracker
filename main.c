...
#define SCAN_INTERVAL               0x1320                              /**< Determines scan interval in units of 0.625 millisecond. */
#define SCAN_WINDOW                 0x1320                              /**< Determines scan window in units of 0.625 millisecond. */
