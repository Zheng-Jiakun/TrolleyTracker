PROJECT_NAME     := ble_app_rscs_c_pca10040_s132
...
$(OUTPUT_DIRECTORY)/nrf52832_xxaa.out: \
  LINKER_SCRIPT  := ble_app_rscs_c_gcc_nrf52.ld
...
SRC_FILES += \
  ...
  $(SDK_ROOT)/components/ble/ble_services/ble_dis_c/ble_dis_c.c \
  $(SDK_ROOT)/components/ble/ble_services/ble_rscs_c/ble_rscs_c.c \
...
INC_FOLDERS += \
  ...
  $(SDK_ROOT)/components/ble/ble_services/ble_dis_c \
